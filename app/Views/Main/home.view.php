<section id="banner-image">
    <div class="home-image-banner">
        <img class="home-image-banner-width" src="/assets/images/welcome.jpg" alt="">
    </div>

    <div class="home-spacing"></div>

    <div class="home-slogan">
        <h1 class="white-text home-slogan-text"><i><strong>Vos <b class="red-text">Critiques</b> ont une histoire</strong></i></h1>
    </div>
</section>
...
<section id="events">
    <div class="event">
        <div class="event-banner">
            <h2 class="white-text">Liste des médias</h2>
            <h3 class="light-gray-text">Vous cherchez un film en particulier ? <br> C'est ici que ça se passe !</h3>
