...
<section id="categories">
    <div class="container-95">
        <h2 class="white-text">Categories</h2>
        <div class="horizontal-line horizontal-line-categories">
            <div class="white-text"> Left </div>
...
<section>
    <h2 class="white-text container-95">Categories</h2>
...
<section id="popular-reviews">
    <div class="container-95">
        <h2 class="white-text">Critiques populaires</h2>
    </div>

    <div class="container-75 list-of-reviews">
