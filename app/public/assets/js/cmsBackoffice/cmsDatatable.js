    ...
    .then(function (data) {
      ...
      var tableData = data.map(function (row) {
        ...
        return {
          name: row[12],
          pictureData:
            '<img class="cms-img" src="' +
            row[11] +
            '" alt="Movie Picture" style="width: 100px; height: 150px;">',
          userData: row[19],
          ...
          button:
            '<button type="button" class="btn btn-primary view-btn" data-id="' +
            row[0] +
            '">Afficher</button>',
          button2:
            '<button type="button" class="btn btn-warning update-btn" data-id="' +
            row[0] +
            '">Modifier</button>',
          button3:
            '<form method="post" action="back-delete-cms">' +
